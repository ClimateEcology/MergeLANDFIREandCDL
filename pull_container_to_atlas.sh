...
singularity pull docker://melaniekamm/geospatial_extend:v1.1
...
cp geospatial_extend_v1.1.sif geospatial_extend_latest.sif # create updated container with same name
